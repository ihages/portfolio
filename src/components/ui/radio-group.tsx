  ...
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        ...
        "dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:bg-input/30 aspect-square size-[10px] shrink-0",
    ...
    >
      ...
      >
        <CircleIcon className="fill-primary absolute top-1/2 left-1/2 size-[5px] -translate-x-[2.5px] -translate-y-[2.5px]" />
      </RadioGroupPrimitive.Indicator>
    </RadioGroupPrimitive.Item>
  )
}
