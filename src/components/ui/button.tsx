...
const buttonVariants = cva(
  "px-4 py-2 has-[>svg]:px-3 bg-primary/30 shadow-xs hover:bg-primary/90 focus-visible:border-primary inline-flex items-center justify-center gap-2 border-1 border-transparent whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none p-[10px] ",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-xs hover:bg-primary/80 focus-visible:border-primary focus-visible:ring-primary/50 no-underline",
        destructive:
          "bg-destructive/90 text-background border-transparent text-destructive-foreground shadow-xs hover:bg-destructive/80 focus-visible:border-destructive focus-visible:ring-destructive/50",
        outline:
        ...
        link: "bg-transparent border-transparent text-foreground/90 underline-offset-4 hover:underline focus-visible:border-transparent focus-visible:ring-transparent hover:bg-transparent",
      },
      size: {
